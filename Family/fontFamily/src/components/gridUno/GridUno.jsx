...
export const GridUno = () => {
  return (
    <>
      <div className="gridUno">
        <h2 className="h2GridUno">El mundo de la tipografia</h2>
        <p className="pGridUno">
          con nuestra herramienta de selección de font-family. Explora una
